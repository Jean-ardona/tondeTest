import React, { useRef, useEffect, useContext, type ReactNode, type ElementType } from 'react';
...
function CSSTransition({
  ...
  return (
    ...
    >
      {/* ref forwarding via cast */}
      {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
      <Component ref={nodeRef as any} {...rest} style={{ display: !removeFromDom ? 'none' : undefined }}>
        {children}
      </Component>
    </ReactCSSTransition>
  );
