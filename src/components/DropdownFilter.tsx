...
function DropdownFilter({ align }: DropdownFilterProps) {
  ...
  const checkRefs = {
    ...
    TopChannels: useRef<HTMLInputElement>(null),
    ...
    <div className="relative inline-flex">
      ...
      >
        <div ref={dropdown}>
          ...
          <ul className="mb-4">
            {[
              { ref: checkRefs.DirectorIndirect, label: "Direct VS Indirect" },
              { ref: checkRefs.RealTimeValue, label: "Real Time Value" },
              { ref: checkRefs.TopChannels, label: "Top Channels" },
              { ref: checkRefs.SalesRefunds, label: "Sales VS Refunds" },
              { ref: checkRefs.LastOrder, label: "Last Order" },
              { ref: checkRefs.TotalSpent, label: "Total Spent" },
            ].map(({ ref, label }) => (
          ...
          <div className="py-2 px-3 border-t border-gray-200 dark:border-gray-700/60 bg-gray-50 dark:bg-gray-700/20">
            <ul className="flex items-center justify-between">
              <li>
                <button onClick={handleFilters} className="btn-xs bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-red-500">
                  Clear
                </button>
              </li>
              <li>
